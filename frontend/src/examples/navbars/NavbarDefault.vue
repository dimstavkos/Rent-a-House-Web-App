    ...
    >
      ...
      >
        <ul class="navbar-nav navbar-nav-hover ms-auto">
                ...
                <div class="col-12 px-4 py-2">
                  <div class="row">
                    <div class="position-relative">
                      ...
                      <RouterLink
                        :to="{ name: 'renter-properties' }"
                        class="dropdown-item border-radius-md"
                      >
                        <span>My Bookings</span>
                      </RouterLink>
                      <RouterLink
                        :to="{ name: 'renter-recommended-properties' }"
                        class="dropdown-item border-radius-md"
                      >
          ...
          <li v-if="store.is_guest !== 'false'" class="nav-item mx-2">
            <a
              role="button"
              class="nav-link ps-2 d-flex cursor-pointer align-items-center"
              :class="getTextColor()"
                ...
                <div class="col-12 px-4 py-2">
                  <div class="row">
                    <div class="position-relative">
                      ...
                      <RouterLink
                        :to="{ name: 'user-myprofile', params: { id: 1 } }"
                        class="dropdown-item border-radius-md"
                      > 
                        <span>Profile</span>
                      </RouterLink>
        ...
        <ul class="navbar-nav d-lg-block d-none">
          ...
          >
            <MaterialButton
              v-if="store.is_guest == 'true'"
              color="success"
              class="w-auto my-2 ms-3"
            >
              Sign-in
            </MaterialButton>
          </RouterLink>
